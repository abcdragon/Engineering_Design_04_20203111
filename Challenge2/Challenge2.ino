...
float arr[ARRAY_SIZE], sorted[ARRAY_SIZE]; // save sensor data
int n = 3;

void setup(){// initialize GPIO pins
...
// initialize USS related variables
  ...
  dist_raw = median = 0.0; // raw distance output from USS (unit: mm)
...
void loop() {
  ...
  if(dist_raw < dist_min || dist_raw > dist_max) {
    ...
    int bright = 255 * abs(dist_raw - 200) * 0.01;
